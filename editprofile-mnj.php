        ...
        <div class="flex h-screen">
                    ...
                    <div class="bg-white px-6 py-4 shadow-sm flex justify-between items-center">
                        ...
                        <div class="p-8">
                            ...
                            <form action="profilepage-mnj.php" method="POST" class="bg-gray-200 rounded-lg shadow p-6 flex flex-col lg:flex-row gap-6">
                                <!-- Form Kiri -->
                                <div class="flex-1 space-y-4">
                                    <!-- Nama Lengkap -->
                                    <div>
                                        <label class="block text-sm font-medium text-gray-900 mb-1">Nama Lengkap</label>
                                        <input type="text" name="nama" class="w-full bg-gray-300 text-gray-900 px-4 py-2 rounded-md" value="Jamal Mulyadi" readonly>
                                    </div>
                    ...
                    <div class="flex gap-4 pt-4">
                        <a href="profilepage-mnj.php" class="bg-blue-800 text-white px-6 py-2 rounded-md font-medium hover:bg-blue-900">Batalkan</a>
                ...
                <div class="flex flex-col items-center justify-start border-l pl-6">
                    <img src="foto-jamal.jpg" class="w-24 h-24 rounded-full border-4 border-blue-900 object-cover mb-4">
