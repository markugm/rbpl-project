    ...
    <main class="flex-1 overflow-y-auto">
      ...
      <div class="px-6 py-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <button class="flex items-center gap-2 bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded transition">
            <i class="bi bi-plus"></i> Bab Baru
          </button>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <!-- Kartu Kursus -->
          <div class="rounded-xl shadow bg-white px-4 py-3 flex flex-col h-40">
