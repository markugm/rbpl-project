            ...
            <script>
                ...
                kursusList.forEach((item, index) => {
                    kursusContainer.innerHTML += `
                        <div onclick="lihatDetail(${index})" class="cursor-pointer bg-gray-100 rounded-xl shadow px-4 py-3 flex gap-4 items-start h-[170px]">
                            ...
                            <div>
                                <h3 class="font-semibold text-sm mb-1 truncate">${item.judul}</h3>
